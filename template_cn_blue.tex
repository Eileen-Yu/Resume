...
\cvline{\textbf{软件}}{SPSS | MS Office | PS | Premiere}
\cvline{\textbf{其他}}{熟练掌握摄影技能 | 良好的文字功底}

\section{实习经历}
\cventry{19.06-\textbf{至今}}{Quest Mobile}{数据分析师}{}{}{\hspace{0.7cm}
监测移动互联网行业动向，基于对各APP、小程序的大数据爬虫和用户调研，针对需求进行数据分析，跟进客户项目、制定研究框架、输出行研报告。全程跟进B站“出圈“”用户增长及市场沟通策略项目，立足于供给端与需求端，从内容、品牌形象、渠道、竞品四方面确定维度指标，交付行研报告及可行参考方案。撰写China Joy公开报告与演讲稿、中国移动互联网2019半年大报告等多份内容。
}

\section{项目经历}
\cventry{19.06-\textbf{至今}}{短视频与社交营销大数据分析}{SJTU大数据与传播创新实验室(T-lab)}{}{}{\hspace{0.7cm}使用Python及相关统计工具分析以抖音为代表的短视频APP的社交营销效果。通过大数据，对抖音平台用户性别、年龄、地域使用时长、使用频率、使用时段进行画像；爬取十余类商品的销售趋势并划分量级，与用户属性交叉分析；爬取并分析KOL私域流量构成与带货转化率。}
