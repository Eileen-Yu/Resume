...
\section{项目经历}
\cventry{19.06-\textbf{至今}}{SJTU大数据与传播创新实验室(T-lab)}{短视频与社交营销大数据分析}{}{}{\hspace{0.7cm}使用Python和R语言等统计工具分析以抖音为代表的短视频APP的社交营销效果。通过大数据，对抖音平台用户性别、年龄、地域使用时长、使用频率、使用时段进行画像；爬取十余类商品的销售趋势并划分量级，与用户属性交叉分析；爬取并分析KOL私域流量构成与带货转化率。}
