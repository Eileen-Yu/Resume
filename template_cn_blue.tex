...
\cventry{19.09-\textbf{至今}}{卡夫亨氏}{消费者洞察部门实习生}{}{}{\begin{itemize}
   \item[•] 撰写月度销售报告和市场趋势分析；通过桌面调研分析竞品动向；协助跟进财务流程和其他日常工作。
   \item[-] 通过整合来自不同线上和线下销售数据供应商（如尼尔森）提供的500余条数据，独立撰写月度销售报告；提取公司数据库的资源进行市场整体趋势和公司目标量化分析。
   \item[-] 立足于电商平台、财经投资与公开报告、营销活动等监测主要竞品的最新动向；从消费者画像、销量、定价、成本等多维度比较分析数据，提出建议并被采纳。
   \item[-] 协助财务流程的完整执行，从开具PO申领预算，到确认收货准备资料完成请款。
\end{itemize}}
