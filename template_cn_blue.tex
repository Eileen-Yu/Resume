...
\cventry{19.06-\textbf{至今}}{Quest Mobile}{数据分析师}{}{}{\begin{itemize}
   \item[-] 监测移动互联网行业动向，基于对各APP、小程序的大数据爬虫和用户调研，针对需求进行数据分析，跟进客户项目、制定研究框架、输出行研报告。
   \item[-] 全程跟进B站“出圈“”用户增长及市场沟通策略项目，立足于供给端与需求端，从内容、品牌形象、渠道、竞品四方面确定维度指标，交付行研报告及可行参考方案。
   \item[-] 撰写China Joy公开报告与演讲稿、中国移动互联网2019半年大报告等多份内容。
\end{itemize}}


\section{项目经历}
\cventry{19.06-\textbf{至今}}{短视频与社交营销大数据分析}{SJTU大数据与传播创新实验室(T-lab)}{}{}{\begin{itemize}
   \item[-] 使用Python及相关统计工具分析以抖音为代表的短视频APP的社交营销效果。
   \item[-] 通过大数据，对抖音平台用户性别、年龄、地域、使用时长、使用频率、使用时段进行画像.
   \item[-] 爬取十余类商品的销售趋势并划分量级，与用户属性交叉分析
 爬取并分析KOL私域流量构成与带货转化率。
\end{itemize}}
\cventry{18.10-18.12}{光明品牌公关调研与策划}{}{}{}{\begin{itemize}
   \item[-] 对光明乳业公关状况进行全面调研并使用ROPE模式提出一个完整的公关活动策划案。
   \item[-] 通过媒介监测、报表分析、数据收集基本了解企业的公关运营情况。
   \item[-] 利用SPSS进行ANOVA分析与多元线性回归分析，确立公关目标群体，制定公关主题、宣传语及线上线下联动合作活动执行方案。提出公关效果预期与评估。
\end{itemize}}
\cventry{18.09-18.12}{上海交通大学院级部门组织诊断}{}{}{}{\begin{itemize}
   \item[-] 独立完成学院组织诊断，发现组织架构、绩效、文化、人际关系等方面的问题并提出相关建议。
   \item[-] 前期通过在线问卷对组织内部人员进行相关调查，确立七个相关维度，并进行访谈设计。
   \item[-] 对员工、管理层在内的40位人员进行面对面访谈，对相关问题进行频次统计并整理记录，针对性提出建议，撰写诊断报告。
\end{itemize}}
\cventry{17.09-18.01}{鲜花电商市场营销状况调研}{}{}{}{\begin{itemize}
   \item[-] 对2017年四季度的电商鲜花市场营销状况进行全面分析及预测趋势。
   \item[-] 前期通过媒介监测获取数据监测报告，使用焦点小组访谈形式收集相关信息。
   \item[-] 中期对线上线下融合的鲜花电商进行实地调研、搜集反馈信息、收集案例。
   \item[-] 后期综合数据信息、绘制趋势图，撰写总结报告并提出市场预测。
\end{itemize}}
