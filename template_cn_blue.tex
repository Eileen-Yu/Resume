...
\section{实习经历}
\cventry{19.06-\textbf{至今}}{Quest Mobile}{数据分析师}{}{}{\setlength\parindent{8pt}
\indent - 监测移动互联网行业动向，基于对各APP、小程序的大数据爬虫和用户调研，针对需求进行数据分析，跟进客户项目、制定研究框架、输出行研报告。 \\
\indent - 全程跟进B站“出圈“”用户增长及市场沟通策略项目，立足于供给端与需求端，从内容、品牌形象、渠道、竞品四方面确定维度指标，交付行研报告及可行参考方案。 \\
\indent - 撰写China Joy公开报告与演讲稿、中国移动互联网2019半年大报告等多份内容。
}
